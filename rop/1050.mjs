...
// libSceNKWebKit.sprx
let libwebkit_base = 0x91ff500d;
// libkernel_web.sprx
let libkernel_base = 0x194c00;
...
//
// When the scrollLeft getter native function is called on PS4 10.50, rsi is the
...
class Chain1050Base extends ChainBase {
    constructor() {
        super();
...
// Chain for PS4 10.50
class Chain1050 extends Chain1050Base {
    constructor() {
        super();
